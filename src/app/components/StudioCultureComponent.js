...
const StudioCultureComponent = ({ studioCulture, culturalValues, adoptCulturalValue, removeCulturalValue, studioLevel }) => {
    ...
    const availableSlots = 3 - studioCulture.values.length;
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    <div className="bg-white rounded-lg p-6 max-w-2xl w-full max-h-[80vh] overflow-y-auto">
                        <div className="flex justify-between items-center mb-4">
                            <h2 className="text-xl font-bold">Studio Cultural Values</h2>
                            <button 
