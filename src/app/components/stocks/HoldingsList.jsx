...
const HoldingsList = React.memo(({ holdings, stocks, onTradeClick }) => {
  // Memoize dividend info calculation to prevent recalculation on each render
  const getDividendInfo = useCallback((stock, holding) => {
  ...
  // Memoize the holdings data to prevent recalculation
  ...
  }, [holdings, stocks, getDividendInfo]);
  ...
  return (
    <div className="space-y-1">
      {holdingsData.map(({ holding, stock, currentValue, gainLoss, gainLossPercent, dividend }) => (
